...
router.post('/addProducts',upload.fields([{name:'images', maxCount:3},{name:'image', maxCount:"1"}]),controller.postaddProducts)
router.post('/unlist-product/:id', controller.unlistProduct)
router.post('/edit-product',upload.fields([{name:'images', maxCount:3},{name:'image', maxCount:"1"}]),controller.postEditProduct)
